...
| Find in Files and Replace in Files, command palette, keyboard shortcuts reference, focus mode | `components/SearchPanel.tsx`, `features/replaceInFiles.ts`, `CommandPalette.tsx`, `ShortcutsDialog.tsx` | §5 power user needs |
