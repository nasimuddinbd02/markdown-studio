...
- Export to PDF (selectable text, clickable links, heading bookmarks, tables, task checkboxes, images, footnotes) and to Word (.docx) with real Word headings, numbered/bulleted/task lists, tables, code, links, embedded images and native Word footnotes
