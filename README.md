...
- Command palette (Ctrl/Cmd+Shift+P), document outline (right-click a heading to copy a link to it or move its section; Alt+Up/Down moves the focused section), and Find in Files across the workspace (Ctrl/Cmd+Shift+F; match case, whole word, regex)
