...
const MENUS: { label: string; items: (recent: RecentEntry[]) => Item[] }[] = [
  {
    ...
    items: (recent) => [
      ...
      sep, c("save"), c("saveAs"), c("saveAll"), c("fileHistory"), sep, c("importDocx"), c("importPdf"), c("importHtml"), c("importCsv"), c("convertFolder"), c("combineFolder"), sep, c("exportPdf"), c("exportDocx"), c("exportHtml"), c("copyHtml"), c("print"), c("exportFolderPdf"), c("exportFolderDocx"), sep, c("closeTab"), c("closeFolder"), sep, c("settings"),
    ],
  },
  {
    label: "Edit",
